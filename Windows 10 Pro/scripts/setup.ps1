...
Write-Output "Activate Remote Powershell..."
Enable-PSRemoting

#Enable Remote Desktop
#Write-Output "Activate Remote Desktop..."
#Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\Terminal Server' -name "fDenyTSConnections" -value 0
#Add Firewall Rule for RDP
Write-Output "Add RDP Firewall Rules..."
...
#Create .ssh folder
Write-Output "Create SSH folders..."
cd $env:USERPROFILE
mkdir .ssh
#Download Vagrant Key SSH File
Write-Output "Downloading Vagrant SSH Keys..."
$source = 'https://raw.githubusercontent.com/hashicorp/vagrant/main/keys/vagrant.pub'
$destination = '%USERPROFILE%\.ssh\authorized_keys'
Invoke-WebRequest -Uri $source -OutFile $destination

Write-Output "Configure PowerShell prompt..."
